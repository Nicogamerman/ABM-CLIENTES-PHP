...
/* Creating variables from the form data. */
if ($_POST) {
    $dni = $_POST["txtDni"];
            ...
            <div class="col-6">
                <form action="" method="POST" class="form" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <input type="correo" name="txtCorreo" id="txtCorreo" class="form-control" value="<?php echo isset($aClientes[$id])? $aClientes[$id]["correo"] : ""; ?>"<?php echo isset($disabled)? $disabled : "";  ?> required>
                    </div>
            ...
            <div class="col-sm-6">
                <table class="table table-hover border">
                    ...
                    <?php foreach ($aClientes as $pos => $cliente) : ?>
                        <!-- //el foreach recibe el array $aClientes , as $cliente que va a ser cada cliente individual. -->
                        <tr>
